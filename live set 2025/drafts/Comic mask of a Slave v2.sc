...
(
    ...
    x = {
        ...
        \a.postln;
            ...
            // b = Buffer.read(s, "/Users/aelazary/Desktop/Samples etc./Field recs/drain paris audrey.wav");
            ...
            Ndef(\sample).set(\buf, b, \pos, 0, \rate, 0.25, \loop, 1, \gain, 0).play([~bus2.channels].flatten);
            ...
            //     \dur, 0.01, 
            //     \num_teeth, ~knob.(5).linlin(0, 1, 2, 32).floor, 
