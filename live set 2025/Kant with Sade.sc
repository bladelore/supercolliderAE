(
    ...
    ~specBuff = Dictionary(); ~makeSpec.("/Users/aelazary/Desktop/Samples etc./ZOOM H5/Coburg bush reserve/Playground vibraphone.wav", ~specBuff, 16384, 2);

    // ~specBuff = SpecBuf(s, "/Users/aelazary/Desktop/Samples etc./ZOOM H5/Coburg bush reserve/Playground vibraphone.wav", ~specBuff, 16384, 2, verlaps: 2, numChannels: 2);
